...
public class SharedTorrent extends Torrent implements PeerActivityListener {
	 ...
	 *             If the torrent file cannot be read or decoded.
	 */
	public SharedTorrent(Torrent torrent, File destDir, boolean seeder, RequestStrategy requestStrategy)
			throws FileNotFoundException, IOException, NoSuchAlgorithmException {
	 ...
	 *             If the torrent file cannot be read or decoded.
	 */
	public SharedTorrent(byte[] torrent, File parent, boolean seeder, RequestStrategy requestStrategy)
			throws FileNotFoundException, IOException, NoSuchAlgorithmException {
	...
	/**
	 * Get the number of pieces in this torrent. 文件块的数量
	 */
